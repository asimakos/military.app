...
Begin VB.Form Form4 
   Caption         =   "Διοίκηση - Επιτελείο  724  ΤΜΧ   (Ομαδική   καταχώρηση   δεδομένων)"
   ClientHeight    =   6210
   ClientLeft      =   2280
   ClientTop       =   570
   ClientWidth     =   7515
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "             Ομαδική  καταχώρηση   δεδομένων  για  διοίκηση - επιτελείο"
      ColumnCount     =   16
...
Text1.Text = "N"
MsgBox " Αποθηκεύτηκαν " & CStr(i - 1) & " εγγραφές επιτυχώς! "
End Sub
