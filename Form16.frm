...
Begin VB.Form Form16 
   Caption         =   "Γεφυροσκευής  λόχος - Επιλογή  προσωπικού  ανάλογα  με  τα  καθήκοντα"
   ClientHeight    =   6195
   ClientLeft      =   2220
   ClientTop       =   1050
   ClientWidth     =   7950
   ...
   Begin VB.Label Label1 
      Caption         =   "Επιλέξτε  την  διμοιρία  του στελέχους"
      Height          =   375
      Left            =   120
      TabIndex        =   4
      Top             =   480
...
CMD.CommandText = "SELECT spec,rank,corps,p_spec,p_rank," & _
                "surname,f_name FROM c_in WHERE team LIKE '%" & Trim(x) & "'"
