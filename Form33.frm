...
Begin VB.Form Form30 
   Caption         =   "Καταχώρηση  δεδομένων  για   λόχο   διοικήσεως"
   ClientHeight    =   6390
   ClientLeft      =   285
   ClientTop       =   1005
   ClientWidth     =   8190
...
CMD.CommandText = "SELECT * FROM d_in"
...
RS.MoveNext
Wend
Form36.RichTextBox1.Text = y & x
Form36.Show
End Sub

Private Sub Command5_Click()

Form36.CommonDialog1.Flags = cdlPDReturnDC + cdlPDNoPageNums
If Form36.RichTextBox1.SelLength = 0 Then
Form36.CommonDialog1.Flags = Form36.CommonDialog1.Flags + cdlPDAllPages
Else
Form36.CommonDialog1.Flags = Form36.CommonDialog1.Flags + cdlPDSelection
End If
Form36.CommonDialog1.ShowPrinter
Printer.Print ""
Form36.RichTextBox1.SelPrint Form36.CommonDialog1.hDC
End Sub
