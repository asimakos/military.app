...
Begin VB.Form Form27 
   Caption         =   "Καταχώρηση   δεδομένων  για   δεύτερο  λόχο"
   ClientHeight    =   6390
   ClientLeft      =   285
   ClientTop       =   1230
   ClientWidth     =   8190
...
CMD.CommandText = "SELECT * FROM b_in"
...
RS.MoveNext
Wend
Form33.RichTextBox1.Text = y & x
Form33.Show
End Sub

Private Sub Command5_Click()

Form33.CommonDialog1.Flags = cdlPDReturnDC + cdlPDNoPageNums
If Form33.RichTextBox1.SelLength = 0 Then
Form33.CommonDialog1.Flags = Form33.CommonDialog1.Flags + cdlPDAllPages
Else
Form33.CommonDialog1.Flags = Form33.CommonDialog1.Flags + cdlPDSelection
End If
Form33.CommonDialog1.ShowPrinter
Printer.Print ""
Form33.RichTextBox1.SelPrint Form33.CommonDialog1.hDC
End Sub
