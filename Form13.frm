...
Begin VB.Form Form13 
   Caption         =   "Διοίκηση - Επιλογή  προσωπικού  ανάλογα  με  τα  καθήκοντα"
   ClientHeight    =   6195
   ClientLeft      =   2235
   ClientTop       =   780
   ClientWidth     =   7950
   ...
   Begin VB.Label Label1 
      Caption         =   "Επιλέξτε τα  καθήκοντα   του  στελέχους"
      Height          =   375
      Left            =   120
      TabIndex        =   5
      Top             =   600
...
CMD.CommandText = "SELECT spec,rank,corps,p_spec,p_rank," & _
                "surname,f_name FROM com_in WHERE team LIKE '" & Trim(x) & "%'"
